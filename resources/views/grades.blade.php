<x-app-layout> 
    ...
    <div class="min-h-screen bg-mainback flex flex-col">
        <div class="flex-1 overflow-y-auto">
            <div class="relative">
                <!-- Loading Screen -->
                <div id="loading-screen" class="flex flex-col items-center justify-center flex-1 bg-mainback transition-opacity duration-1500 min-h-[80vh] h-[80dvh]">
                    <div class="h-20 w-20 rounded-full border-[0.5rem] border-gray-200 border-t-navgreen animate-spin"></div>
                    <p class="text-2xl font-semibold mt-4">
                        Loading<span id="dots" class="inline-block">...</span>
                    </p>
                </div>
                <div class="max-w-7xl mx-auto sm:px-4 lg:px-6 py-8 sm:py-10 lg:py-12" id="main-content" hidden>
                    <!-- Responsive heading -->
